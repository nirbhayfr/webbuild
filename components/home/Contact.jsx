			...
			<div className="container">
				<div className="row">
						...
						<div className="contact-left">
							<div className="sec-heading">
								...
								<h2 className="sec-title tj-split-text-1">
									Have any Questions on Mind? Get in
									Touch for Market Experts.
								</h2>
								...
								>
									<a
										className="tj-primary-btn mt-25 d-none d-lg-inline-flex"
										href="contact.html"
									>
							...
							{/* Contact Info */}
							<div
								className="contact-info tj-fade-anim"
								data-delay="0.3"
							...
							>
								<div className="contact-item">
									...
									<a
										className="contact-link"
										href="mailto:support@tekmino.com"
									>
										support@tekmino.com
									</a>
								</div>
					...
					<div className="col-xl-6 col-lg-7">
						<div
							className="contact-form style-2 tj-fade-anim"
							data-delay="0.3"
